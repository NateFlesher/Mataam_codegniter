...
<div class="container header-container">
    ...
    <div class="row twin_btn">
        ...
        <a href="<?php echo site_url('admin/index/z4_1_mc_charge/'.$com_Name)?>"><button class="col-sm-3 btn btn_mid active"><span>Bank Details & charges</span></button></a>
	...
	<form>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $.ajax({
                    type : 'POST',
                    url : "<?php echo site_url('admin/index/getBankList')?>",
                    dataType : 'json',
                ...
                $('.bank_update').click(function(event){
                    ...
                    var data = {
                        accHolderName : accHolderName, bankName : bankName, branch : branch, accountNum : accountNum, IBAN : IBAN, swiftCode : swiftCode, debt_PF : debt_PF, debt_charge : debt_charge, credit_PF : credit_PF, credit_charge : credit_charge, chargeAllocation : chargeAllocation, company : company, client : client, com_Name : com_Name
                    };

                    $.ajax({
                        type : 'POST',
                        url : "<?php echo site_url('admin/index/bank_update')?>",
                        dataType : 'json',
                        data :  data,
                        success : function(res){
                            if(res)
