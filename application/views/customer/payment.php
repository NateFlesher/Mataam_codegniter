...
<div class="container header-container">
	...
	<div class="row content">
		<div class="form-group row twin_btn2">
			<a href="<?php echo site_url('customer/index/payment')?>"><button class="col-sm-6 btn btn_send active"><span>Send Payments</span></button></a>
		    <a href="<?php echo site_url('customer/index/request')?>"><button class="col-sm-6 btn btn_request"><span>Request Payments</span></button></a>
		</div>
		<form>
