...
<div class="container header-container">
    ...
    <div class="row twin_btn1">
        ...
        <a href="<?php echo site_url('admin/index/z7_2_privacy_pol')?>"><button class="col-sm-2 btn btn_mid active"><span>Privacy Policy</span></button></a>
    ...
    <form>
        <div class="row">
            ...
            <div class="form-group col-md-10 sub-form left_align">
                <label for="privacy_pol_list">Privacy Policy: </label>
                <textarea class="form-control footer_text" type="text" name="privacy_pol_list" id="privacy_pol_list"></textarea>
            </div>
        </div>
        <div class="row">
            <span class="col-md-5"></span>
            <button class="col-md-2 btn btn-default input-submit privacy_update">
                <span>Update</span>
            </button>
        </div>
    </form>
  ...
  <script type="text/javascript">
        $(document).ready(function(){
            $('#privacy_pol_list').val('<?php echo $privacy_pol;?>');

            $('.privacy_update').click(function(){
                $.ajax({
                    url: "<?php echo site_url('admin/index/privacy_update');?>",
                    data: 'privacy_pol='+ $('#privacy_pol_list').val(),
                    dataType: 'JSON',
                    type: 'POST',
