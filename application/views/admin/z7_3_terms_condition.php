...
<div class="container header-container">
    ...
    <div class="row twin_btn1">
        ...
        <a href="<?php echo site_url('admin/index/z7_3_terms_condition')?>"><button class="col-sm-3 btn btn_mid active"><span>Terms & Coditions</span></button></a>
    ...
    <form>
        <div class="row">
            ...
            <div class="form-group col-md-10 sub-form left_align">
                <label for="terms_con_list">Terms & Conditions: </label>
                <textarea class="form-control footer_text" type="text" name="terms_con_list" id="terms_con_list" class="form-control"></textarea>
            </div>
        </div>
        <div class="row">
            <span class="col-md-5"></span>
            <button class="col-md-2 btn btn-default input-submit terms_update">
                <span>Update</span>
            </button>
        </div>
    </form>
  ...
  <script type="text/javascript">
        $(document).ready(function(){
            $('#terms_con_list').val('<?php echo $terms_condition;?>');

            $('.terms_update').click(function(){
                $.ajax({
                    url: "<?php echo site_url('admin/index/terms_update');?>",
                    data: 'terms_condition='+ $('#terms_con_list').val(),
                    dataType: 'JSON',
                    type: 'POST',
